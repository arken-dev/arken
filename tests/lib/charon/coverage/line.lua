...
test.should_return_one_for_before_line_function = function()
  local keywords = { flag1 = 0, flag2 = 0, flag3 = 0, str1 = false, str2 = false }
  assert( coverage.line("function teste()", nil, keywords) == 1 )
end

test.should_return_one_for_before_line_function_is_blank_space = function()
  local keywords = { flag1 = 0, flag2 = 0, flag3 = 0, str1 = false, str2 = false }
  assert( coverage.line(" function teste()", nil, keywords) == 1)
end
...
test.should_return_one_for_around_space = function()
  local keywords = { flag1 = 0, flag2 = 0, flag3 = 0, str1 = false, str2 = false }
  assert( coverage.line(" function() ", nil, keywords) == 1)
end
