local DateTime = require('arken.chrono.Time')
local test = {}

test.should_parse_date_only = function()
  local str = "2015-07-04"
  local dt  = DateTime.parse(str)
  assert( dt:toString() == '2015-07-04 00:00:00', dt:toString() )
end
...
test.should_parse_date_hour_minute = function()
  ...
  local dt  = DateTime.parse(str)
  assert( dt:toString() == '2015-07-04 13:45:00', dt:toString() )
end

test.should_parse_date_hour_minute_second = function()
  local str = "2015/07/04 13:45:30"
  local dt  = DateTime.parse(str)
  assert( dt:toString() == '2015-07-04 13:45:30', dt:toString() )
end
...
test.should_return_date_without_hour_for_invalid = function()
  local str = "2015/07/04 abcdef"
  local dt  = DateTime.parse(str)
  assert( dt:toString() == '2015-07-04 00:00:00', tostring(dt) )
end
