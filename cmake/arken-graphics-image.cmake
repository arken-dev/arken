option(ARKEN_GRAPHICS_IMAGE "enable arken.graphics.Image" false)
...
if(ARKEN_GRAPHICS_IMAGE)

  file(GLOB files ${PROJECT_SOURCE_DIR}/src/arken/graphics/image/*.cpp)
  set(arken-graphics-image ${files})
...
message("ARKEN_GRAPHICS_IMAGE........: ${ARKEN_GRAPHICS_IMAGE}")
